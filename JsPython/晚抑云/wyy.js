...
function getparam(keyword) {
    let d1 = {"hlpretag":"<span class=\"s-fc7\">","hlposttag":"</span>","s":keyword,"type":"1","offset":"0","total":"true","limit":"30","csrf_token":""}  //"offset" 起始位置，翻页用
    let e =  '010001';
    ...
    param = d(JSON.stringify(d1),e,f,g)
